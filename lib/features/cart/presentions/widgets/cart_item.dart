...
class CartItem extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
      return Row(
          children: [
            Image.network(cartModel!.productModel.image,height: 96.h,width: 68.w,),
            SizedBox(width: 18.w,),
            Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                Text(cartModel!.productModel.name,style: Theme.of(context).textTheme.labelSmall,),
                Text(cartModel!.productModel.price.toString(),style: Theme.of(context).textTheme.labelSmall!.copyWith(color: AppColors.mainColor),),
