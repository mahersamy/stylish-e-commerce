...
class SettingRepo{
  ...
  Future<Either<String, UserModel>> getProfile() async{
    try {
      final response = await FirebaseFirestore.instance
          .collection(FirebaseStrings.users).get();
      return Right(UserModel.fromJson(response.docs.first.data()));
    } catch (e) {
  ...
  Future<Either<String, Unit>> changeProfile(Map<String, dynamic> json) async{
    try {
      final response = await FirebaseFirestore.instance.collection(FirebaseStrings.users)
